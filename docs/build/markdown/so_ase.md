...
## so_ase.eval_cavity module

### so_ase.eval_cavity.fesom_subshelf_freshwaterflux(src_path, mesh_diag_path, mesh_path, mask, years=(1979, 2015), log=False, savepath='./')
...
### so_ase.eval_cavity.fesom_subshelf_heatflux(src_path, mesh_diag_path, mesh_path, mask, years=(1979, 2015), log=False, savepath='./')
...
### so_ase.eval_cavity.fesom_subshelf_hydrography(src_path, mesh_diag_path, mesh_path, mask, years=(1979, 1980), variable='temp', log=False, savepath='./')
...
### so_ase.eval_cavity.freshwaterflux_to_massflux_Gtm(src_path, dst_path, rho_fw=1000, log=True)
...
### so_ase.eval_cavity.freshwaterflux_to_massflux_Gty(src_path, dst_path, rho_fw=1000, log=True)
...
## so_ase.eval_icebergs module

### so_ase.eval_icebergs.read_iceberg_initial_files(icebergpath)
...
### so_ase.eval_ocean.fesom_total_kinetic_energy(src_path, mesh_diag_path, meshpath, years=(1979, 2015), mask='cavity', log=False, savepath='./')
...
### so_ase.eval_sea_ice.fesom_ice_volume(src_path, mesh_diag_path, years=(1979, 2015), box=[-180, 180, -90, -60], savepath='./', log=True)
...
### so_ase.eval_sea_ice.fesom_sea_ice_area(src_path, mesh_diag_path, years=(1979, 2025), box=[-180, 180, -90, -60], siconc_threshold=0.15, savepath='./', log=True)
...
### so_ase.helpers_mesh.add_element_volumes(mesh_diag)
...
### so_ase.helpers_mesh.add_nodal_volumes(mesh_diag)
...
### so_ase.helpers_mesh.build_cavity_mask(meshpath, which='element')
...
### so_ase.helpers_mesh.build_cavity_regional_mask(meshpath, kml_path, which='Filchner-Ronne')
...
### so_ase.helpers_mesh.build_elements_of_nodes(elements, node_idx)
...
### so_ase.helpers_mesh.build_node_neighbors(elements, node_idx)
...
### so_ase.helpers_mesh.build_runoff_basin_mask(meshpath, runoff_file, which='liquid')
...
### so_ase.helpers_mesh.level_idx_to_depth(meshpath, which='seafloor', raw=False)
...
### so_ase.helpers_mesh.mesh2vtk(meshpath, which='seafloor')
...
### so_ase.helpers_mesh.read_depth_zlev(meshpath)
...
### so_ase.helpers_mesh.read_element_levels(meshpath, which='seafloor', raw=False, python_indexing=False)
...
## so_ase.helpers_misc module

### so_ase.helpers_misc.lon_to_360(lon)
...
### so_ase.helpers_misc.read_kml_coords(path, close_ring=True)
...
### so_ase.helpers_misc.seconds_per_month(years)
...
### so_ase.helpers_plots.remove_axes_frame(ax, left=True, right=True, top=True, bottom=True, ticks=True, labels=True)
...
### so_ase.plotting_maps.plot_on_elements(ax, lon, lat, elements, data, mask, vmin='None', vmax='None', cmap='RdBu', zorder=1)
